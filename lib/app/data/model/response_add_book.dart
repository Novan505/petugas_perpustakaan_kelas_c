...
class ResponAddBook {
  ...
  ResponAddBook.fromJson(dynamic json) {
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? DataResponAddBook.fromJson(json['data']) : null;
  }
  int? status;
  String? message;
  DataResponAddBook? data;
...
class DataResponAddBook {
  ...
  DataResponAddBook.fromJson(dynamic json) {
